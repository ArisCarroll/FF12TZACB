...
public class ArcaneMagick {
	...
	private void getArcMagIcons() {
		...
		notW[0] = new ImageIcon(MainGui.class.getResource("/dmf/tzacb/assets/icons/licenses/arcMag/yArcaneMagick1W.PNG"));
		yesW[0] = new ImageIcon(MainGui.class.getResource("/dmf/tzacb/assets/icons/licenses/arcMag/yArcaneMagick1W.PNG"));
		...
		notW[1] = new ImageIcon(MainGui.class.getResource("/dmf/tzacb/assets/icons/licenses/arcMag/nArcaneMagick2W.PNG"));
		yesW[1] = new ImageIcon(MainGui.class.getResource("/dmf/tzacb/assets/icons/licenses/arcMag/yArcaneMagick2W.PNG"));
		...
		notW[2] = new ImageIcon(MainGui.class.getResource("/dmf/tzacb/assets/icons/licenses/arcMag/nArcaneMagick3W.PNG"));
		yesW[2] = new ImageIcon(MainGui.class.getResource("/dmf/tzacb/assets/icons/licenses/arcMag/yArcaneMagick3W.PNG"));
