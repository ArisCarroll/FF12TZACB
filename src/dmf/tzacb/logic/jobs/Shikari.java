...
public class Shikari extends LicenseBoard {
	...
	public Shikari(PlayerCharacter holder, Accessories accessories, ArcaneMagick arcm, Armor armor, BattleAugments battleAug, BlackMagick blm, EspersQuickEssentials eqee, 
		...
		licenseGrid[13][column] = itemAug.getItemAugmentCopy(9);
		...
		licenseGrid[5][column] = technicks.getTechnickCopy(30);
		...
		licenseGrid[11][column] = armor.getArmorCopy(35);
		
		licenseGrid[12][column] = weapons3.getWeapon3Copy(5);
		
		licenseGrid[13][column] = armor.getArmorCopy(37);
		...
		licenseGrid[3][column] = battleAug.getBattleLoreCopy(16);
		...
		licenseGrid[13][column] = armor.getArmorCopy(45);
		licenseGrid[14][column] = armor.getArmorCopy(38);
		...
		licenseGrid[1][column] = weapons3.getWeapon3Copy(8);
		
		licenseGrid[2][column] = eqee.getEQEECopy(0);
		
		licenseGrid[3][column] = eqee.getEQEECopy(2);
		...
		licenseGrid[11][column] = armor.getArmorCopy(34);
		licenseGrid[12][column] = armor.getArmorCopy(44);
		...
		licenseGrid[0][column] = weapons3.getWeapon3Copy(7);
		...
		licenseGrid[5][column] = weapons3.getWeapon3Copy(0);
		
		licenseGrid[6][column] = armor.getArmorCopy(27);
		
		licenseGrid[7][column] = weapons3.getWeapon3Copy(1);
		
		licenseGrid[8][column] = armor.getArmorCopy(40);
		licenseGrid[9][column] = armor.getArmorCopy(30);
		licenseGrid[10][column] = armor.getArmorCopy(41);
		licenseGrid[11][column] = armor.getArmorCopy(32);
		licenseGrid[12][column] = armor.getArmorCopy(43);
		...
		licenseGrid[3][column] = healthAug.getHealthAugmentCopy(0);
		licenseGrid[4][column] = magAug.getMagickLoreCopy(24);
		
		licenseGrid[5][column] = eqee.getEQEECopy(1);
		
		licenseGrid[6][column] = armor.getArmorCopy(26);
		licenseGrid[7][column] = armor.getArmorCopy(28);
		licenseGrid[8][column] = armor.getArmorCopy(29);
		
		licenseGrid[9][column] = weapons3.getWeapon3Copy(2);
		
		licenseGrid[10][column] = armor.getArmorCopy(31);
		licenseGrid[11][column] = armor.getArmorCopy(42);
		
		licenseGrid[12][column] = battleAug.getBattleLoreCopy(20);
		...
		licenseGrid[11][column] = battleAug.getBattleLoreCopy(19);
		licenseGrid[12][column] = battleAug.getBattleLoreCopy(22);
		
		licenseGrid[13][column] = accessories.getAccessoryCopy(17);
		licenseGrid[14][column] = accessories.getAccessoryCopy(20);
		licenseGrid[15][column] = accessories.getAccessoryCopy(22);
		...
		licenseGrid[13][column] = accessories.getAccessoryCopy(16);
		...
		licenseGrid[6][column] = accessories.getAccessoryCopy(4);
		licenseGrid[7][column] = accessories.getAccessoryCopy(6);
		...
		licenseGrid[2][column] = technicks.getTechnickCopy(19);
		
		licenseGrid[3][column] = eqee.getEQEECopy(0);
		
		licenseGrid[4][column] = battleAug.getBattleLoreCopy(0);
		...
		licenseGrid[11][column] = itemAug.getItemAugmentCopy(0);
		...
		licenseGrid[3][column] = battleAug.getBattleLoreCopy(3);
		licenseGrid[4][column] = battleAug.getBattleLoreCopy(2);
		licenseGrid[5][column] = itemAug.getItemAugmentCopy(6);
		...
		licenseGrid[11][column] = battleAug.getBattleLoreCopy(18);
		licenseGrid[12][column] = magAug.getMagickLoreCopy(1);
		...
		licenseGrid[4][column] = battleAug.getBattleLoreCopy(4);
		licenseGrid[5][column] = battleAug.getBattleLoreCopy(5);
		...
		licenseGrid[11][column] = technicks.getTechnickCopy(13);
		
		licenseGrid[12][column] = itemAug.getItemAugmentCopy(2);
		licenseGrid[13][column] = magAug.getMagickLoreCopy(3);
		licenseGrid[14][column] = battleAug.getBattleLoreCopy(25);
		...
		licenseGrid[2][column] = weapons3.getWeapon3Copy(32);
		licenseGrid[3][column] = weapons3.getWeapon3Copy(31);
		...
		licenseGrid[13][column] = weapons3.getWeapon3Copy(10);
